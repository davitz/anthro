// InstallOptions_FluvioExamplesPaint.cs
...
public static class InstallOptions_FluvioExamplesPaint
{
    static bool s_OpenExampleScene = true;

    #region Constructors
    static InstallOptions_FluvioExamplesPaint()
    {
    ...
    static bool OnPostInstall(string packageName)
    {
        ...
        {
            EditorPrefs.SetString("Thinksquirrel.FluvioEditor.OpenExampleScene", "Paint");
