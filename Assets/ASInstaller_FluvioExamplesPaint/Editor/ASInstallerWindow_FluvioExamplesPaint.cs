// ASInstallerWindow_FluvioExamplesPaint.cs
...
public class ASInstallerWindow_FluvioExamplesPaint : EditorWindow
{
    ...
    void OnEnable()
    {
        m_KeyImage = Resources.Load("ASInstaller_FluvioExamplesPaint-512x64", typeof (Texture2D)) as Texture2D;
        m_Readme = Resources.Load("README_FluvioExamplesPaint", typeof (TextAsset)) as TextAsset;
